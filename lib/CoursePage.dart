      ...
      body: Container(
        ...
        child: Column(
          ...
          children: <Widget>[
            ...
            Text('For Beginners to Advance', style: TextStyle(
            ...
            Expanded(
              child: SingleChildScrollView(
                child: Column(
                  children: <Widget>[
                    productListing('Introduction ', 'Day 1', 'active'),
                    productListing('2nd Topic', 'Day 2', 'inactive'),
                    productListing('3rd Topic', 'Day 3', 'inactive'),
                    productListing('Ending', 'Day 4', 'inactive'),
                    productListing('Bonus', 'Day 5', 'inactive'),
                  ],
                ),
              ),
            )
