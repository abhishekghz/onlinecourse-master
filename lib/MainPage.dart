                  ...
                  children: <Widget>[
                    Container(
                      ...
                      child: Column(
                        mainAxisAlignment: MainAxisAlignment.spaceBetween,
                        children: <Widget>[
                          courseWidget('Programming', 'Oops using C++', 'img1', Color(0xffff6a65), Colors.white),
                          SizedBox(height: 20,),
                          courseWidget('Programming', 'Web Development', 'img2', Color(0xffe9eefa), Colors.white),
                        ],
                      ),
                    ),
                    Container(
                      ...
                      child: Column(
                        ...
                        children: <Widget>[
                          SizedBox(height: 50,),
                          courseWidget('Programming', 'Python', 'img3', Color(0xffe9eefa), Colors.white),
                          SizedBox(height: 20,),
                          courseWidget('Programming', 'Android Development', 'img4', Color(0xffbdcddfa), Color(0xffcedaff)),
                        ],
                      ),
                    )
                  ],
